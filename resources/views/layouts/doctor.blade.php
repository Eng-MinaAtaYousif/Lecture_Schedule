...
<body>
    ...
    <div class="main">
        ...
        <div class="student_top_header bg-gradient-to-r from-cyan-500 to-blue-500">
            <div class="type_name">
                ...
                <h1> Doctor <span> {{ $req->username }} </span> </h1>
            </div>
        ...
        <div class="student_left_actions bg-dark">
            <ul>
                <li class="li"
                    ...
                    Dashport </li>
                <li class="text-blue-700 li"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                ...
                <li class="text-blue-700">
                    ...
                    <a href="{{ route('suggestion', ['username' => $req->username]) }}">Make Suggestions </a>
                </li>
    ...
    <script>
        function n() {
            ...
            li = document.querySelector('li.li');
