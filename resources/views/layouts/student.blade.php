    ...
    <div class="main">
        ...
        <div class="student_top_header bg-gradient-to-r from-cyan-500 to-blue-500">
            <div class="type_name">
                ...
                <h1> Student <span> {{ $req->username }} </span></h1>
            </div>
        ...
        <div class="student_left_actions bg-dark">
            ...
            <ul>
                <li style="font-size: 30px;margin-bottom:20px;background-color:rgb(28, 28, 130);padding-left:10px;margin-top:30px">
                    Dashport </li>
                ...
                <li class="text-blue-700"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                    ...
                    </svg><a href="{{ route('student_department_info', ['username' => $req->username]) }}"> Student
                        Info
                    </a></li>
