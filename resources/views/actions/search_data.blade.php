...
<div class="load">
        ...
        <div class="real-data"> 
             <ul>
                ...
                @empty
                <h1 class="wrong_id"> Sorry ; there is no data may be query is wrong or ID not found</h1>
                @endforelse
             ...
             <ul>
                ...
                @empty
                  <h1 class="wrong_username"> Sorry ; there is no data may be query is wrong or ID not found</h1>
