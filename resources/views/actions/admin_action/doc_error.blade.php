...
<body class="loading">
    ...
    <h3>
        <a href="{{ route('admin_add_doctor_or_assestant', ['username' => $req->username]) }}"
            style="font-size:25px;width:250px" class="justify-content-center btn btn-danger">Try Again</a>
    </h3>
