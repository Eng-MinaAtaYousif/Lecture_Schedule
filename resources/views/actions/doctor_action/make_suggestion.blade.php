...
@section('content')
    <div class="post col-lg-9 col-md-9 col-sm-9">
        <form id="algin-form" action="{{ route('doc_publish_suggestion', ['username' => $req->username]) }}"
    ...
    {{-- <audio src="{{ asset('audios/notifications.ogg') }}" controls style="display: none" id="sound"></audio>
    <script>
        var sound, post;
